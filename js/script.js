  ...
  return `
    <div class="product-card">
      <div class="product-img-wrapper" onclick="navigateToProductId(${p.id})">
        ...
        <button class="product-buy-btn" onclick="event.stopPropagation(); addToCart(${p.id})" style="background:#FFE600;color:#2D3277;"><img src="/Mercado%20libre.png" alt="ML" class="buy-ml-icon"><i class="fas fa-shopping-cart buy-fa-icon"></i><span class="buy-btn-text">Comprar en Mercado Libre</span></button>
      </div>
...
function openCompareModal() {
  ...
  const data = compareList.map(p => {
    ...
    return {
      ...
      actions: '<button class="cmp-cart" onclick="addToCart(' + p.id + ')" style="background:#FFE600;color:#2D3277;">Comprar en Mercado Libre</button>' +
      ...
      <div class="detail-info">
        ...
        <div class="detail-actions">
          ${product.meli_url
            ...
            : `<button class="detail-add-cart" onclick="addToCart(${product.id})" style="background:#FFE600;color:#2D3277;"><i class="fas fa-shopping-cart"></i> Comprar en Mercado Libre</button>`
          }
        </div>
